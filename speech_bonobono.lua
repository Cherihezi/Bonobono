...
return {
	...
	PETALS_EVIL = "I'm not sure if I want to hold those.",
		...
		-- Crow Carnival
		CARNIVAL_HOST = "I wonder if he could let me ride on his back...",
		CARNIVAL_CROWKID = "Wow, a little crow! I'm Bonobono! Do you live around here too?",
		CARNIVAL_GAMETOKEN = " It's so round and smooth, like a perfect little moon!",
        ...
        RABBITKINGSPEAR = "Ah, what if Mr. Putaway Man finds out about this?",
        RABBITHAT = "I've never had a bunny as a pet before!",
        WORM_BOSS = "It must be Mr. Putaway Man's pet monster!",
    ...
    DESCRIBE_PLANTHAPPY = "I wonder if it smiles when it gets sunshine?",
    DESCRIBE_PLANTVERYSTRESSED = "It probably needs more water or sunlight, right?",
    DESCRIBE_PLANTSTRESSED = "It must be missing its friends or feeling too much sun.",
    DESCRIBE_PLANTSTRESSORKILLJOYS = "Something's bothering our friends!",
    ...
    EAT_FOOD =
    {
        TALLBIRDEGG_CRACKED = "I ate it...",
		WINTERSFEASTFUEL = "Wah! It tastes great!",
    },
}
